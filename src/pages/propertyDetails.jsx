...
try {
const res = await fetch(`https://real-backend-p7ph.onrender.com/api/property/${id}`);
...
return ( <div className="bg-slate-100 dark:bg-slate-900 min-h-screen">
...
```
  ...
  <div className="relative w-full h-[520px] overflow-hidden">
    {(property.images?.[0] || property.vrImage) && (
      <img
        src={`https://real-backend-p7ph.onrender.com${property.images?.[0] || property.vrImage}`}
        alt="Property"
  ...
  <div className="max-w-7xl mx-auto px-6 mt-6">
    {property.images?.length > 0 && (
      <img
        src={`https://real-backend-p7ph.onrender.com${property.images[0]}`}
    ...
    <div className="lg:col-span-2 space-y-10">
      ...
      <div className="bg-white rounded-2xl p-8 shadow">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-50 Properties rounded-xl p-5 text-center">
            📐 Built-up Area
